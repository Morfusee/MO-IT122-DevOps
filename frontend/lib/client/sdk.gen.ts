...
import type { GetUsersData, GetUsersResponse, PostUsersData, PostPromptData, PostPromptResponse, PostRegisterData, PostRegisterResponse, PostRegisterError, PostLoginData, PostLoginResponse, PostLoginError, PostLogoutData, PostLogoutResponse, GetMeData, GetMeResponse, GetChatsData, GetChatsResponse, PostChatsData, PostChatsResponse, DeleteChatsByIdData, GetChatsByIdData, GetChatsByIdResponse, PatchChatsByIdData, PatchChatsByIdResponse, PutChatsByIdData, PutChatsByIdResponse, GetChatsByChatIdMessagesData, GetChatsByChatIdMessagesResponse, PostChatsByChatIdMessagesData, PostChatsByChatIdMessagesResponse } from './types.gen';
...
export const getChatsByChatIdMessages = <ThrowOnError extends boolean = false>(options: Options<GetChatsByChatIdMessagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetChatsByChatIdMessagesResponse, unknown, ThrowOnError>({
...
export const postChatsByChatIdMessages = <ThrowOnError extends boolean = false>(options: Options<PostChatsByChatIdMessagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostChatsByChatIdMessagesResponse, unknown, ThrowOnError>({
        url: '/chats/{chat_id}/messages',
        ...options,
        headers: {
            'Content-Type': 'application/json',
